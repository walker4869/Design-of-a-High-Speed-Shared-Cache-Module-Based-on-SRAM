...
HD_PWD='D:/vivado_works/switch/switch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_top_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source switch_top_tb.tcl
