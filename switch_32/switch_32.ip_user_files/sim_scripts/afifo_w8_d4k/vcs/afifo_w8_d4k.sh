...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.afifo_w8_d4k xil_defaultlib.glbl -o afifo_w8_d4k_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./afifo_w8_d4k_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key afifo_w8_d4k_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc afifo_w8_d4k_simv.daidir vcs_lib c.obj)
