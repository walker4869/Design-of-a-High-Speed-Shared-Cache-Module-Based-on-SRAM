...
#                script (type 'sram_w128_d2k.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sram_w128_d2k xil_defaultlib.glbl -o sram_w128_d2k_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sram_w128_d2k_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sram_w128_d2k_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sram_w128_d2k_simv.daidir vcs_lib c.obj)
