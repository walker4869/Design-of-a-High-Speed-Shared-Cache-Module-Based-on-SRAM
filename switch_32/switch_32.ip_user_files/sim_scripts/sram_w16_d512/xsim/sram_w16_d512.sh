...
#
# Script generated by Vivado on Sat May 04 14:36:15 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : sram_w16_d512.sh
...
#
# Usage        : sram_w16_d512.sh
#                sram_w16_d512.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sram_w16_d512.sh [-reset_run]
#                sram_w16_d512.sh [-reset_log]
#                sram_w16_d512.sh [-help]
#
...
# script info
echo -e "sram_w16_d512.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sram_w16_d512.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sram_w16_d512 xil_defaultlib.sram_w16_d512 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sram_w16_d512 -key {Behavioral:sim_1:Functional:sram_w16_d512} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sram_w16_d512.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sram_w16_d512.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sram_w16_d512.sh [-help]\n\
Usage: sram_w16_d512.sh [-step]\n\
Usage: sram_w16_d512.sh [-lib_map_path]\n\
Usage: sram_w16_d512.sh [-reset_run]\n\
Usage: sram_w16_d512.sh [-reset_log]\n\
Usage: sram_w16_d512.sh [-keep_index]\n\
Usage: sram_w16_d512.sh [-noclean_files]\n\n\
