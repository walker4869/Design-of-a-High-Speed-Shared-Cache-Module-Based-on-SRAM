...
#
# Script generated by Vivado on Sat May 04 14:06:49 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : sfifo_w16_d32.sh
...
#
# Usage        : sfifo_w16_d32.sh
#                sfifo_w16_d32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sfifo_w16_d32.sh [-reset_run]
#                sfifo_w16_d32.sh [-reset_log]
#                sfifo_w16_d32.sh [-help]
#
...
#                script (type 'sfifo_w16_d32.sh -help' for more information).
#
...
# script info
echo -e "sfifo_w16_d32.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sfifo_w16_d32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sfifo_w16_d32 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sfifo_w16_d32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sfifo_w16_d32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sfifo_w16_d32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sfifo_w16_d32.sh [-help]\n\
Usage: sfifo_w16_d32.sh [-step]\n\
Usage: sfifo_w16_d32.sh [-lib_map_path]\n\
Usage: sfifo_w16_d32.sh [-reset_run]\n\
Usage: sfifo_w16_d32.sh [-reset_log]\n\
Usage: sfifo_w16_d32.sh [-keep_index]\n\
Usage: sfifo_w16_d32.sh [-noclean_files]\n\n\
