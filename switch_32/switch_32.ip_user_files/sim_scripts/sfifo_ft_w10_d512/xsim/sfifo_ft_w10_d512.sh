...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sfifo_ft_w10_d512 xil_defaultlib.sfifo_ft_w10_d512 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sfifo_ft_w10_d512 -key {Behavioral:sim_1:Functional:sfifo_ft_w10_d512} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sfifo_ft_w10_d512.wdb xsim.dir libdpi.so)
